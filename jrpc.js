...
const banner = cfonts.render(("LADY APIS"), {
font: "block",
align: "center",
...
await listkeys(apikey, req);
url = req.query.url
 if (!url) return res.json({ status : false, criador : `SANDRO BOT & FANTASMA MODS`, mensagem : "Coloque o parametro: url"})
...
app.get('/api/canvas/karaba', bobross)
